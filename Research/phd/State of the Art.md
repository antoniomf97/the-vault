...
Agent design comes as one of the most critical attributes in the AI impact on humans populations. The architecture of the [[research/notes/cognition/Cognitive Profile|cognitive profile]] of agents will dictate how AAs behave in the world, hence shaping the cooperative outcomes of society. In this complex topic, the literature converges on a small number of manipulable dimensions that directly influence the agent's effect on human cooperation.

The first dimension is conditionality, or whether the agent's actions are dependent on its recipient behavior or not.  
